...
class ApiMethods(object):
    ...
    def get_business_patners(self, **kwargs):
        # KODE NEW
    ...
    def update_company(self, **kwargs):
        ...
        :param body: Company info data to update. Company object.
        """
        method = "PUT"
        endpoint = "company"
    ...
    def get_latest_currency_rate(self, rateType):
        ...
        method = "GET"
        endpoint = "currencies/latest?rateType={}".format(rateType)
    ...
    def create_dimension_item(self, dimensionId, **kwargs):
        """Method create a new item for dimension

        :param body: DimensionItem object.
        """
    ...
    def update_dimension_item(self, dimensionId, **kwargs):
        """Update item in dimension
        :param body: DimensionItem object to update
        """
    ...
    def post_invoice_comment(self, invoiceId, **kwargs):
        """
        :param invoiceId: ID of the invoice
        :param body: CommentDTO, dict
    ...
    def get_invoice_paymentevents(self, invoiceId, **kwargs):
        """Get payment events
    ...
    def markpaid_invoice(self, invoiceId, **kwargs):
        """
    ...
    def post_payment(self, **body):
        """Pay invoices
        :param body: PaymentsList object
        :return: Dictionary
        """
        method = "POST"
        endpoint = "payments"
    ...
    def get_product_groups(self, **kwargs):
        ...
        :return: list with request status code 'status' and list of product groups 'content', list
        """
    ...
    def get_session_info(self):
        ...
        :return: Dictionary with keys: status and content
        """
